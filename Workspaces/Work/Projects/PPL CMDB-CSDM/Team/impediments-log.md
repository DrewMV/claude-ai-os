...
| 4 | 2026-05-13 | 2.1 | 🏛️ **[Portfolio & Leadership Issue · ADO 1425697]** **Service Mapping Blocked** — Missing credentials and environment access restrictions preventing Service Mapping progress. Directly impacts PI Objective 3 (Expand Service Mapping Foundation). _(ADO: "Missing Discovery Credentials Blocking Service Mapping"; 2-Portfolio escalation, ROAM Owned, assigned Joe Dames.)_ | Joe Dames | Open | |
