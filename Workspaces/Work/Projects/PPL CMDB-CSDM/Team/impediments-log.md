...
| 2 | 2026-05-13 | 2.1 | 🏛️ **[Portfolio & Leadership Issue · ADO 1425785]** **Credential Readiness (Discovery-Critical)** — SNMP credentials not confirmed fully working. CyberArk integration not confirmed complete. Credential propagation across environments (servers, DBs, network devices) pending. Blocking discovery accuracy and CMDB integrity. _(ADO: "We require a functioning SNMP credential in CyberArk"; 2-Portfolio escalation, ROAM Owned, assigned Joe Dames.)_ **6/19 progress:** CyberArk safe access being unblocked — tasks 1445179 (SNMPv3 creds added to SERVNW safe) & 1445181 (SRS exception for CLDSCPE/GWIZ safes) **Closed** (Anthony, under 1444864). | Joe Dames | Open | |
...
| 4 | 2026-05-13 | 2.1 | 🏛️ **[Portfolio & Leadership Issue · ADO 1425697]** **Service Mapping Blocked** — Missing credentials and environment access restrictions preventing Service Mapping progress. Directly impacts PI Objective 3 (Expand Service Mapping Foundation). _(ADO: "Missing Discovery Credentials Blocking Service Mapping"; 2-Portfolio escalation, ROAM Owned, assigned Joe Dames.)_ **6/19 progress:** CyberArk safe-access tasks 1445179/1445181 Closed (see #2); SolarWinds Service Mapping PoC advanced — steps 1–2 (Data Gathering, Build Mapping) Closed. | Joe Dames | Open | |
...
| 14 | 2026-06-08 | 2.3 | **Qualys Plugin Pending Vendor Approval** — Stan requested a new Qualys plugin for the dev environment; current plugin not working. Blocked by pending vendor (Qualys) approval before installation can proceed. Directly blocks PI Obj 4 (Qualys integration). | Stan | Open | |
| 15 | 2026-06-08 | 2.3 | **Laurent Missing Dev Admin Access** — Laurent lacks admin privileges on dev instance, blocking completion of Airlift stories. Needs 2–3 hours of Dev Admin support. Meeting with Stan scheduled 12pm Eastern 2026-06-08 to resolve. Directly blocks PI Obj 6 (Airlift). | Alex Lim / Stan | Open | |
| 16 | 2026-06-08 | 2.3 | **Tony — Linux Credential Permissions Blocking Discovery** — Ongoing Linux server credential permission errors during discovery runs. Tony working with Stan and Mukesh on resolution. API integration work complete in dev but needs PO acceptance to move to QA. Blocks PI Obj 1 discovery coverage. | Tony | Open | |
| 17 | 2026-06-17 | 2.3 | 👥 **[Product & Team Issue · ADO 1338923]** **Servers - Classification Attribute Purpose** — Open impediment on the purpose of the classification attribute on Server CIs. _(ADO: 4-Team escalation, ROAM Owned, assigned Joe Dames; due 2026-06-17 — OVERDUE.)_ ⚠️ **Reconcile with #12** — possible overlap with the "data classification / SOX indicator" field-necessity question; confirm with Joe whether distinct or duplicate. | Joe Dames | Open | |
