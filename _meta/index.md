...
Auto-maintained index of all wiki pages. Updated by `/wiki-ingest`, `/wiki-update`, and `/daily-update`.
...
- [SAFe-lean-portfolio-management](../Workspaces/Work/Projects/knowledge-scraping/SAFe-lean-portfolio-management.md) — LPM discipline, funding, governance, 9+ competencies
- [SAFe-team-and-technical-agility](../Workspaces/Work/Projects/knowledge-scraping/SAFe-team-and-technical-agility.md) — Agile Teams, ART, Built-in Quality, CDP, 6 competencies
- [SAFe-product-development-flow](../Workspaces/Work/Projects/knowledge-scraping/SAFe-product-development-flow.md) — Product vision, Lean UX, Design Thinking, 8 competencies
- [SAFe-large-solution-delivery](../Workspaces/Work/Projects/knowledge-scraping/SAFe-large-solution-delivery.md) — Solution Train, LSID discipline, 6 competencies
- [SAFe-leadership-and-culture](../Workspaces/Work/Projects/knowledge-scraping/SAFe-leadership-and-culture.md) — Business Agility, dual OS, Kotter's 8 accelerators
- [SAFe-roles](../Workspaces/Work/Projects/knowledge-scraping/SAFe-roles.md) — All SAFe roles at team, ART, Solution Train, portfolio level
- [SAFe-planning-and-events](../Workspaces/Work/Projects/knowledge-scraping/SAFe-planning-and-events.md) — PI Planning, iterations, I&A, WSJF, all events
- [SAFe-backlogs-and-artifacts](../Workspaces/Work/Projects/knowledge-scraping/SAFe-backlogs-and-artifacts.md) — 4-tier requirements hierarchy, stories, enablers, NFRs
- [SAFe-flow-and-delivery](../Workspaces/Work/Projects/knowledge-scraping/SAFe-flow-and-delivery.md) — CDP, flow metrics, Measure and Grow, OKRs
- [SAFe-devops-and-technical-practices](../Workspaces/Work/Projects/knowledge-scraping/SAFe-devops-and-technical-practices.md) — CALMR, TDD, BDD, Agile Architecture, Set-Based Design
- [SAFe-implementation-roadmap](../Workspaces/Work/Projects/knowledge-scraping/SAFe-implementation-roadmap.md) — 13-step adoption journey, SAFe customization
- [SAFe-ai-and-emerging-topics](../Workspaces/Work/Projects/knowledge-scraping/SAFe-ai-and-emerging-topics.md) — AI in SAFe, Responsible AI, Cloud, Big Data, sustainability
...
_Last full rebuild: never — run `/wiki-status` to check coverage._
